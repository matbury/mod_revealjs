...
$string['audioslideshow_help'] = 'Enable text-to-speech and audio synchronisation features. See: <a href="http://courses.telematique.eu/audio-slideshow/" target="_blank">http://courses.telematique.eu/audio-slideshow/</a> for examples.';
...
$string['showhidetranscript'] = 'Show/Hide audio transcript if available';
$string['saveandclose'] = 'Save slideshow position and return to course page';
